...
function ammount() {
    ...
    if (numberofpersons.value < 1) {
        ...
        document.getElementById('Knollensellerie').innerHTML = (0.13 * 1) + ' Stück(e) Knollensellerie'
    ...
    if (numberofpersons.value > 20) {
        ...
        document.getElementById('zwiebel').innerHTML = (Math.round (0.63 * 20 * 100) / 100) + 'Zwiebel(n)'
        ...
        document.getElementById('Knollensellerie').innerHTML = (0.13 * 20) + 'Stück(e) Knollensellerie'
        ...
        document.getElementById('zwiebel').innerHTML = ((0.63* numberofpersons.value).toFixed(2)) + 'Zwiebel(n)'
        document.getElementById('Gewürzgurke').innerHTML = (0.5 * numberofpersons.value) + 'Gewürzgurke(n)'
        ...
        document.getElementById('Knollensellerie').innerHTML = (0.25 * numberofpersons.value) + 'Stück(e) Knollensellerie'
